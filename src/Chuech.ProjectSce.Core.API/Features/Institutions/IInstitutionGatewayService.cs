...
public interface IInstitutionGatewayService
{
    Task<InstitutionMember> JoinAsync(Institution institution, int userId, InstitutionRole institutionRole,
            EducationalRole educationalRole);

    Task QuitAsync(InstitutionMember member);
}
public class InstitutionGatewayService : IInstitutionGatewayService
{
    ...
    public Task<InstitutionMember> JoinAsync(Institution institution, int userId, InstitutionRole institutionRole, EducationalRole educationalRole)
    {
